...
const products = [
  {
    ...
    code: "GD-BZ",
    status: "Còn hàng",
    image: "Assets/Motorbikes/auds3r.jpg",
    shortdesc:
      "Phi 22mm. Bằng thép. Ghi đông - Tay lái moto, su gn 125, honda win, husky, rebel, daelim vs125, honda cg125, yamaha yb125, su gd110 độ bobber, chopper.",
  ...
  },
  {
    ...
    image: "Assets/Motorbikes/auds3r.jpg",
    shortdesc:
      "Ghi đông - Tay lái kiểu zin CB-400 VTEC phi 22mm. Chiều dài khoảng 66-68cm. Màu xi mạ.",
  ...
  },
  {
    ...
    image: "Assets/Motorbikes/auds3r.jpg",
    shortdesc:
      "Ghi đông kiểu Sport Honda CR650R phi 22mm. Chất liệu nhôm dày 4mm chắc chắn.",
    desc: "Ghi đông kiểu Sport Honda CR650R phù hợp cho các dòng xe thể thao, classic, drag. Kiểu dáng mạnh mẽ, thể thao.",
    features: ["Chất liệu: Nhôm dày", "Đường kính: 22mm", "Kiểu dáng sport"],
    reviews: [],
  ...
  },
  {
    ...
    image: "Assets/Motorbikes/auds3r.jpg",
    shortdesc:
      "Ghi đông Clip-on Cafe racer Drag nhôm CNC Phi 31-51mm. Dành cho xe độ cafe racer, drag.",
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  relatedBox.innerHTML = product.related
    .map((rid) => {
      const p = products.find((x) => x.id === rid);
      return `<div class="related-card" onclick="window.location='AccessoriesDetail.html?id=${
        p.id
      }'">
  ...
  function loadProductData() {
    ...
    const productData = {
      ...
      status: "Còn hàng",
      description:
        "Balo Moto Phượt Chính Hãng Taichi RS278 là sản phẩm cao cấp với khả năng chống nước tuyệt đối, thiết kế thông minh và bền bỉ.",
      features: [
    ...
    document.getElementById("product-shortdesc").textContent =
